...
setup(name='skll',
      ...
      entry_points={'console_scripts': ['filter_megam = skll.utilities:main',
                                        'generate_predictions = skll.utilities:main',
                                        'join_megam = skll.utilities:main',
                                        'megam_to_libsvm = skll.utilities:main',
                                        'print_model_weights = skll.utilities:main',
                                        'run_experiment = skll.utilities:main',
                                        'skll_convert = skll.utilities:main',
                                        'summarize_results = skll.utilities:main']},

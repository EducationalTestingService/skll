...
def get_unique_name(feature_name, prev_feature_set, filename):
    ...
    if new_feature_name != feature_name and feature_name not in warned_about:
        print(("Warning: Feature named {} already found in previous files. " +
...
if __name__ == '__main__':
    ...
    for file_num, infile in enumerate(args.megam_file, start=1):
        ...
        print("Loading {}...".format(infile.name).encode('utf-8'),
              file=sys.stderr)
        sys.stderr.flush()
        for line in infile:
            ...
            if stripped_line.startswith('#'):
                ...
                curr_filename_set.add(curr_filename)
            # Ignore TEST and DEV lines and store features
                ...
                if len(split_line) == 2:
                    ...
                    if len(feature_names) != len(set(feature_names)):
                        print(("Error: Duplicate features occur on the line of" +
                               "features for {}.").format(curr_filename).encode('utf-8'),
                              file=sys.stderr)
                        sys.exit(1)
                    feature_values = islice(feature_pairs, 1, None, 2)
                    for feat_name, feat_val in izip(feature_names,
                                                    feature_values):
                        ...
                        try:
                            ...
                            print(("Error: Invalid feature value in feature " +
                ...
                # just means all of them have zero values)
                    ...
                    print(("Warning: No features found for {} in {}. All are " +

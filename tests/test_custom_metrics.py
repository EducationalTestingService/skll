...
def test_api_with_inverted_custom_metric():
    ...
    assert_array_equal(grid_results_dict1["rank_test_score"], grid_results_dict2["rank_test_score"])
...
def test_api_with_custom_prob_metric():
    ...
    grid_score, _ = learner2.train(train_fs, grid_objective="fake_prob_metric", grid_search_folds=3)
    ok_(grid_score > 0.95)

...
class TestVotingLearnersExptsTwo(unittest.TestCase):
    """Test class for second set of voting learner experiment tests."""
    ...
    def check_evaluate_task(self, learner_type, options_dict):
    ...
    def test_evaluate_task(self):
        ...
        for option_values in product(
            ...
            yield self.check_evaluate_task, learner_type, options_dict

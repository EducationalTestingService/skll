...
class TestPreprocessing(unittest.TestCase):
    """Test class for preprocessing tests."""
    ...
    def test_class_map_feature_hasher(self):
    ...
    def make_scaling_data(self, use_feature_hashing=False):
    ...
    def check_scaling_features(self, use_feature_hashing=False, use_scaling=False):
        train_fs, test_fs = self.make_scaling_data(use_feature_hashing=use_feature_hashing)
        ...
        learner.train(
            train_fs, grid_search=True, grid_objective="f1_score_micro", grid_search_folds=3
        )
    ...
    def test_scaling(self):
        yield self.check_scaling_features, False, False
        yield self.check_scaling_features, False, True
        yield self.check_scaling_features, True, False
        yield self.check_scaling_features, True, True

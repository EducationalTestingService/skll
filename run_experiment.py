...
def run_configuration(config_file, local=False, overwrite=True, queue='nlp.q', hosts=None):
    ...
    configurator = ConfigParser.RawConfigParser({'test_location': '', 'log': '', 'results': '', 'predictions': '', "grid_search": False, 'objective': "f1_score_micro", 'scale_features': True, 'probability': False, 'fixed_parameters': '[]', 'param_grids': '[]', 'pos_label_str': None})
